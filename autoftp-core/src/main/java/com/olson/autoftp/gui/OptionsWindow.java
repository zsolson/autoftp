...
public class OptionsWindow extends JDialog
{
	...
	public OptionsWindow(SettingsLoader _settings, LocalDirectory _localDirectory, FTPDirectory _ftpDirectory)
	{
		...
		m_localDirectoryBox.setText(_settings.getLocalDirectoryPath());
		m_ftpAddressBox.setText(_settings.getFTPDirectoryAddress());
		m_usernameBox.setText(_settings.getServerUsername());
		m_passwordBox.setText(_settings.getServerPassword());
		// Deconstruct milliseconds in hours, minutes and seconds
		long milliseconds = _settings.getTimeBetweenMerges();
